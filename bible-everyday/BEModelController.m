...
@interface BEModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation BEModelController
...
{   
    ...
    BEDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"BEDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(BEDataViewController *)viewController];
